...
def load_persisted_workspace_for_account(*, session_state: dict[str, Any] | None = None) -> str:
    ...
    """
    from suite_workspace import _load_legacy_persisted_workspace_id, _read_json, normalize_workspace_id
...
def persist_active_workspace_for_account(workspace_id: str, *, session_state: dict[str, Any] | None = None) -> bool:
    from suite_workspace import _PERSISTED_FILE, _write_json, normalize_workspace_id, workspace_label
