...
6. **Dell → phone synchronization** — **next** — [Item 6 contract](./2026-08-03-item6-dell-phone-cross-device-persistence.md); change on Dell; phone pull shows same Creative document @ same revision.
