...
def _core_chart_overrides() -> dict[tuple[str, str], dict[str, Any]]:
    ...
    return {
        ...
        **__import__(
            "song_catalog.pop_extensions_2026",
            fromlist=["pop_extension_chart_overrides"],
        ).pop_extension_chart_overrides(),
    }
...
def _requested_verified_song_records() -> list[dict[str, Any]]:
    ...
    return [
        ...
        v(
            ...
            "A",
            {
                "Intro": ["A", "Bm7", "C#m7", "Bm7"],
                "Verse 1": ["A", "Bm7", "C#m7", "D/E"] * 3,
            },
            {
                "Intro": ["A", "Bm7", "C#m7", "Bm7"],
                "Verse 1": ["A", "Bm7", "C#m7", "D/E"] * 3,
            ...
            notes="A major humanitarian anthem; full form with modulations in chart override.",
            default_bpm=80,
            default_groove="Ballad",
        ),
        v(
        ...
        v(
            ...
            "Pop",
            "F",
            {"Intro": ["F", "F", "Gm", "Gm", "Bb", "Bb", "F", "F"]},
            {"Intro": ["F", "F", "Gm", "Gm", "Bb", "Bb", "F", "F"]},
            composer="Bruno Mars",
            notes="F-major doo-wop pop — full 16-bar sections in chart override.",
            chart_status=status,
            default_bpm=144,
            default_groove="Pop",
        ),
        v(
            ...
            "Pop",
            "G",
            {"Intro": ["G", "D/F#", "Em7", "D/F#", "Csus2", "Csus2"]},
            {"Intro": ["G", "D/F#", "Em7", "D/F#", "Csus2", "Csus2"]},
            composer="Michael Jackson",
            notes="Gospel-pop soul ballad — full form in chart override.",
            chart_status=status,
            default_bpm=100,
        ...
        v(
            ...
            {"Verse 1": ["F#", "C#", "D#m", "B"]},
            composer="Taylor Swift",
            notes="Country-pop in F# — 130 BPM; full form in chart override.",
            chart_status=status,
            default_bpm=130,
