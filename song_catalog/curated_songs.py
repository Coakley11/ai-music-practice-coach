...
def _requested_verified_song_records() -> list[dict[str, Any]]:
    ...
    return [
        ...
        v(
            ...
            lyric_cues={"Intro": ["piano/guitar atmospheric setup"], "Verse": ["space-travel narrative"], "Pre-Chorus": ["lonely lift"], "Chorus": ["title identity hook"], "Outro": ["repeat chorus color and fade"]},
            notes="Original-key Elton ballad chart in Bb; C7-to-F and slash-bass colors support the floating verse motion.",
        ),
        v(
            "In My Life",
            "The Beatles",
        ...
        v(
            ...
            lyric_cues={"Bass Intro / Verse": ["iconic bass groove"], "Pre-Chorus": ["story tension rises"], "Chorus": ["name/title refrain"], "Bridge": ["darker descending color"], "Outro Vamp": ["repeat bass pocket"]},
            notes="F# minor funk-pop chart; harmony stays sparse so the bass pattern and groove remain the main identity.",
        ),
        v(
            "Love Story",
            "Taylor Swift",
            ...
            "D",
            {
                ...
                "Pre-Chorus": ["G", "A", "Bm", "D", "G", "A", "Bm", "A"],
                "Chorus": ["D", "A", "Bm", "G", "D", "A", "G", "A"],
                "Bridge": ["Bm", "G", "D", "A", "Bm", "G", "D", "A"],
                "Final Chorus (Key Change)": ["E", "B", "C#m", "A", "E", "B", "A", "B"],
                "Outro": ["E", "B", "C#m", "A", "E", "B", "A", "E"],
            },
            {
                "Intro": ["Dadd9", "A", "Bm7", "Gadd9"],
                "Verse": ["Dadd9", "A", "Bm7", "Gadd9", "Dadd9", "A", "Gadd9", "Gadd9"],
                "Pre-Chorus": ["Gadd9", "A", "Bm7", "Dadd9", "Gadd9", "A", "Bm7", "A"],
                "Chorus": ["Dadd9", "A/C#", "Bm7", "Gadd9", "Dadd9", "A", "Gadd9", "A"],
                "Bridge": ["Bm7", "Gadd9", "Dadd9", "A", "Bm7", "Gadd9", "Dadd9", "A"],
                "Final Chorus (Key Change)": ["Eadd9", "B/D#", "C#m7", "Aadd9", "Eadd9", "B", "Aadd9", "B"],
                "Outro": ["Eadd9", "B/D#", "C#m7", "Aadd9", "Eadd9", "B", "Aadd9", "Eadd9"],
            },
            advanced={
                "Intro": ["Dadd9", "A/C#", "Bm7", "Gadd9"],
                "Verse": ["Dadd9", "A/C#", "Bm7", "Gadd9", "Dadd9", "A/C#", "Gadd9", "Gadd9"],
                "Pre-Chorus": ["Gadd9", "Aadd4", "Bm7", "Dadd9", "Gadd9", "Aadd4", "Bm7", "A"],
                "Chorus": ["Dadd9", "A/C#", "Bm7", "Gadd9", "Dadd9", "A/C#", "Gadd9", "A"],
                "Bridge": ["Bm7", "Gadd9", "Dadd9", "A/C#", "Bm7", "Gadd9", "Dadd9", "A"],
                "Final Chorus (Key Change)": ["Eadd9", "B/D#", "C#m7", "Aadd9", "Eadd9", "B/D#", "Aadd9", "B"],
                "Outro": ["Eadd9", "B/D#", "C#m7", "Aadd9", "Eadd9", "B/D#", "Aadd9", "Eadd9"],
            },
            ...
            guitar_tabs={"Dadd9": "xx0230", "A": "x02220", "Bm7": "x24232", "Gadd9": "320203", "Eadd9": "024100", "B": "x24442", "C#m7": "x46454", "Aadd9": "x02420"},
            notes="Sounding original key D for the main body, with the recorded whole-step final chorus lift to E. Common easy guitar charts often use capo 2 with C-G-Am-F shapes to sound in D.",
        ),
        v(
