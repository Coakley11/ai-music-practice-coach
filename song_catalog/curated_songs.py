    ...
    return [
        ...
        v(
            ...
            "D",
            {
                ...
                "Final Chorus (Key Change)": ["E", "B", "C#m", "A", "E", "B", "A", "E"],
            },
            {
                ...
                "Final Chorus (Key Change)": ["Eadd9", "B/D#", "C#m7", "Aadd9", "Eadd9", "B", "Aadd9", "Eadd9"],
            },
            advanced={
                "Intro": ["Dadd9", "A/C#", "Bm7", "Gadd9"] * 2,
                "Verse": ["Dadd9", "A/C#", "Bm7", "Gadd9", "Dadd9", "A/C#", "Gadd9", "Gadd9"],
                "Pre-Chorus": ["Em7", "Gadd9", "Aadd4", "A", "Em7", "Gadd9", "Aadd4", "A"],
                "Chorus": ["Dadd9", "A/C#", "Bm7", "Gadd9", "Dadd9", "A/C#", "Gadd9", "A"],
                "Bridge": ["Bm7", "Gadd9", "Dadd9", "A/C#", "Bm7", "Gadd9", "Aadd4", "A"],
                "Final Chorus (Key Change)": ["Eadd9", "B/D#", "C#m7", "Aadd9", "Eadd9", "B/D#", "Aadd9", "Eadd9"],
            },
            composer="Taylor Swift",
            lyric_cues={"Verse": ["storybook scene setup"], "Pre-Chorus": ["family-conflict lift"], "Chorus": ["proposal/title hook"], "Bridge": ["quiet plea before final lift"], "Final Chorus (Key Change)": ["whole-step final lift"]},
            guitar_tabs={"Dadd9": "xx0230", "A": "x02220", "Bm7": "x24232", "Gadd9": "320203", "Em7": "022030"},
            notes="Practice-level country-pop chart in D with the recorded-style whole-step final chorus lift to E.",
        ),
        v(
