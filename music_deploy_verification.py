...
CREATIVE_OWNER_PREVIEW_FUNCTIONAL_PREFIX = "68e8976"
CREATIVE_OWNER_PREVIEW_FUNCTIONAL_SHA = "68e8976d7389e7890aeab28c4c236043b7d57c72"
...
def scan_creative_owner_preview_modules_in_source() -> dict[str, Any]:
    ...
    required = (
        ...
        "song_creative_focus.py",
        "song_creative_focus_change.py",
...
def function_source_verification() -> list[dict[str, Any]]:
    ...
    specs = (
        ...
        ("music_workflow_mutation", "update_active_practice_key"),
        ("music_workflow_mutation", "mutate_active_workflow"),
