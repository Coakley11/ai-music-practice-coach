...
st.set_page_config(page_title="AI Music Practice Coach", page_icon="🎵", layout="wide")
...
STYLE_SONGS = {
    "Jazz Swing": ["Autumn Leaves", "Fly Me to the Moon", "All of Me"],
    "Bossa Nova": ["Blue Bossa", "Minor Bossa Study"],
    "Blues": ["12-Bar Blues in F", "C Jam Blues"],
    "Jewish / Klezmer / Wedding": ["Hava Nagila", "Od Yishama", "Siman Tov U'Mazal Tov"],
    "Funk": ["Funk Groove Study", "Chameleon-style Groove"],
    "Pop / Ballad": ["Stand By Me-style Study", "Simple Ballad Study"]
}
...
with tab5:
    ...
    if st.button("Analyze my playing"):
        if not recorded and not uploaded:
            ...
            for x in plan:
                st.write(f"- {x}")
            st.info("Prototype note: this version does not truly detect pitch/rhythm/tone yet. A future version can use audio analysis AI.")
