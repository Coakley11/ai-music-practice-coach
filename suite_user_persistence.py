    ...
    *,
    ...
    try:
        ...
        record_persist_op(
            ...
            last_saved_pick_key=str((core or {}).get("pick_key") or ""),
        )
...
def finalize_suite_reset(
    ...
    *,
    ...
    Matches the Investment reset contract: cloud ``full_session`` is cleared then rewritten
    so phone/Dell/direct open cannot restore the pre-reset session.
    """
...
def render_reset_controls(
    ...
    *,
    ...
    help_text: str = (
        ...
        "Catalog data and user files are not deleted."
    ),
